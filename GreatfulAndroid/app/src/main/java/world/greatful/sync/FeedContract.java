...
public class FeedContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "world.greatful";

    /*
     * Base URI. (content://world.greatful)
     */
    ...
    public static class Entry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.greatful.entries";

        /*
         * MIME type for individual entries.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.greatful.entry";
